        ...
        <section id="products" className="py-8">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center mb-8">
                    <h2 className="text-3xl md:text-4xl font-MontBold text-green-800">
                        Our Products
                    </h2>
                    <Link
                        to="/products"
                ...
                <div className="flex overflow-x-auto pb-4 md:grid md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-6">
                    {products.map((product, index) => (
                        <div
                            key={index}
                            className="flex-shrink-0 w-56 md:w-auto bg-white rounded-xl shadow-lg overflow-hidden"
                        >
                            <div className="relative h-48 bg-green-100">
                                <img
                                    src={product.image}
                                    alt={product.name}
                                    className="w-42 h-full mx-16"
                                />
                            ...
                            <div className="p-4">
                                <h3 className="text-xl font-MontSemibold mb-2 text-green-800">
                                    {product.name}
                                </h3>
                                <button
                                    onClick={() =>
            ...
            {isPopupOpen && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg relative">
                        <h2 className="text-2xl font-MontBold mb-4 text-green-800">
