...
const services = [
    {
        name: "Custom Branded Bottle 1",
        image: bottlelogo,
        category: "Weddings",
    },
    {
        name: "Custom Branded Bottle 2",
        image: bottlelogo,
        ...
        <section id="services">
            <div className="container mx-auto px-4">
                ...
                <p className="text-lg md:text-xl text-center mb-12 text-gray-700 max-w-3xl mx-auto">
                    We specialize in customizing packed water with your own
                    brand for a unique touch. Enhance your brand visibility and
                ...
                <div className="flex flex-wrap justify-center mb-8">
                    {categories.map((category) => (
                        <button
                            key={category}
                            className={`px-4 py-2 m-1 rounded-lg font-medium transition-colors duration-300 ${
          ...
          `}</style>
                    <div className="flex space-x-6 md:space-x-8 min-w-max">
                        {filteredServices.map((service, index) => (
                            <div
                                key={index}
                                className="w-64 md:w-80 flex-shrink-0 mb-6"
                            >
