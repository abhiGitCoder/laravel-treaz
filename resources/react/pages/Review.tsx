    ...
    return (
        <section className="py-20 bg-gradient-to-b from-purple-100 to-blue-100">
            <div className="container mx-auto px-4">
                <h2 className="text-4xl md:text-5xl font-extrabold mb-10 text-center text-purple-800">
                    Share Your Experience
                </h2>
                <form
                    onSubmit={handleSubmit}
                    className="max-w-lg mx-auto bg-white p-8 rounded-2xl shadow-2xl transform  transition duration-300"
                >
                    <div className="mb-6">
                        <label
                            htmlFor="name"
